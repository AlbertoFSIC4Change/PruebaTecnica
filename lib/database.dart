...
class Database {
  final CollectionReference collectionData = FirebaseFirestore.instance
      .collection('data');
  ...
  Future<void> updateDatabaseEntry(String resourceId,
      {String org = "", String place = "", String valid = "", String type = "Test", String photo = "", String logo = ""}) async {
    if (resourceId.isEmpty) {
      ...
      if (org.isNotEmpty) docMap['place'] = org;
      if (org.isNotEmpty) docMap['photo'] = org;
      if (org.isNotEmpty) docMap['logo'] = org;
